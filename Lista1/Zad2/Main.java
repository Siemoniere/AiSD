...
public class Main{
    public static void main (String[] args){
        MySinglyLinkedList l1 = new MySinglyLinkedList();
        MySinglyLinkedList l2 = new MySinglyLinkedList();
    ...
    public static void merge (MySinglyLinkedList l1, MySinglyLinkedList l2){
        l1.merge(l2);
    }
}